...
{
    public class UncreatedPurchaseBillController : MasterDetailController<PurchaseOrderModel, PurchaseOrderDetailModel>
    {
        ...
        public override ActionResult Index(int? startIndex, int? amount, string sortParameter, MPL.MVC.GenericFilter filter)
        {
            ...
            poCount = new PurchaseOrderBFC().RetrieveUncreatedPurchaseBillCount(filter.GetSelectFilters());
            poList = new PurchaseOrderBFC().RetrieveUncreatedPurchaseBill((int)startIndex, (int)amount, sortParameter, filter.GetSelectFilters());

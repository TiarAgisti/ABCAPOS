...
{
    public class UncreatedBillCreditController : MasterDetailController<VendorReturnModel, VendorReturnDetailModel>
    {
        ...
        public override ActionResult Index(int? startIndex, int? amount, string sortParameter, MPL.MVC.GenericFilter filter)
        {
            ...
            soCount = new VendorReturnBFC().RetrieveUncreatedBillCreditCount(filter.GetSelectFilters());
            soList = new VendorReturnBFC().RetrieveUncreatedBillCredit((int)startIndex, (int)amount, sortParameter, filter.GetSelectFilters());

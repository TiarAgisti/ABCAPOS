...
{
    public class UncreatedTransferReceiptController : MasterDetailController<TransferOrderModel, TransferOrderDetailModel>
    {
        ...
        public override ActionResult Index(int? startIndex, int? amount, string sortParameter, MPL.MVC.GenericFilter filter)
        {
            ...
            toCount = new TransferOrderBFC().RetrieveUncreatedTransferReceiptCount(filter.GetSelectFilters());
            toList = new TransferOrderBFC().RetrieveUncreatedTransferReceipt((int)startIndex, (int)amount, sortParameter, filter.GetSelectFilters());

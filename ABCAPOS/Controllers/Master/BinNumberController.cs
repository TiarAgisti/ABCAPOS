...
{
    public class BinNumberController : GenericController<BinModel>
    {
        ...
        public override MPL.Business.IGenericBFC<BinModel> GetBFC()
        {
            return new BinBFC();
        }
        ...
        public override void PreCreateDisplay(BinModel obj)
        {
            SetPreDetailViewBag();
        ...
        public override void PreDetailDisplay(BinModel obj)
        {
            SetPreDetailViewBag();
        ...
        public override void PreUpdateDisplay(BinModel obj)
        {
            SetPreDetailViewBag();
            base.PreUpdateDisplay(obj);
        }

        public override void CreateData(BinModel obj)
        {
            try
            {
                base.CreateData(obj);
        ...
        public override void UpdateData(BinModel obj, FormCollection formCollection)
        {
            try
            {

<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true" CodeBehind="GoodsReturnedByCustomer.aspx.cs" 
    Inherits="ABCAPOS.Report.GoodsReturnedByCustomer.GoodsReturnedByCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            ...
            <uc2:GenericFilterField ID="gffProductCode" runat="server" FieldName="ProductCode" FieldText="Product Code"
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%"
        ...
        <LocalReport ReportPath="Report\GoodsReturnedByCustomer\UserControls\GoodsReturnedByCustomer.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

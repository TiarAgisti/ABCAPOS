<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="ReportOverdue.aspx.cs" Inherits="ABCAPOS.Report.Invoice.ReportOverdue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            <uc2:GenericFilterField ID="gffEndDate" runat="server" FieldName="Date" FieldText="END DATE"
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Invoice\UserControls\ReportOverdue.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="InvoiceBySalesRep.aspx.cs" Inherits="ABCAPOS.Report.Invoice.InvoiceBySalesRep" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Invoice\UserControls\InvoiceBySalesRep.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

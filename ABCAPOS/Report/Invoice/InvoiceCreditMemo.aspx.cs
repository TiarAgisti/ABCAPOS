...
{
    public partial class InvoiceCreditMemo : System.Web.UI.Page
    {
        ...
        private void SetDataSource()
        {
            ...
            var salesRef = "";
            if (gffSalesRef.Selected)
                salesRef = gffSalesRef.TextBoxString.Text;

            var list = new ABCAPOSReportDAC().RetrieveInvoiceCreditMemo(startDate, endDate, warehouseName, customer, salesRef);

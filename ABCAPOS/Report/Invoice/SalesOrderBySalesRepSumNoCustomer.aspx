<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="SalesOrderBySalesRepSumNoCustomer.aspx.cs" Inherits="ABCAPOS.Report.Invoice.SalesOrderBySalesRepSumNoCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Invoice\UserControls\SalesOrderBySalesRepSumNoCustomer.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

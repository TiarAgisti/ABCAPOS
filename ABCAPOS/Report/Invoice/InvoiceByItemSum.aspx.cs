...
{
    public partial class InvoiceByItemSum : System.Web.UI.Page
    {
        ...
        private void SetDataSource()
        {
            ...
            var list = new ABCAPOSReportDAC().RetrieveInvoiceByItemSumReport(startDate, endDate, warehouseName);
            //var list2 = new ABCAPOSReportDAC().RetrieveInvoiceByItemSumSelectFilter(list, GenericFilter1.SelectFilters);
            ...
            ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("InvoiceByItemSumDT", dt as DataTable));

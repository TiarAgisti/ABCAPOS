<%@ Page Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true" CodeBehind="TransactionStockReport.aspx.cs" Inherits="ABCAPOS.Report.Stock.TransactionStockReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Stock\UserControls\TransactionStock.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>
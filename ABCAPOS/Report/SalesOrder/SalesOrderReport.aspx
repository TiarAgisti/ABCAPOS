<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="SalesOrderReport.aspx.cs" Inherits="ABCAPOS.Report.SalesOrder.SalesOrderReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\SalesOrder\UserControls\SalesOrder.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true" CodeBehind="SalesOrderDetailReport.aspx.cs" Inherits="ABCAPOS.Report.SalesOrder.SalesOrderDetailReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <filterfields>
            ...
            <uc2:GenericFilterField ID="gffCode" runat="server" FieldName="Code" FieldText="Kode Sales Order"
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\SalesOrder\UserControls\SalesOrderDetail.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="CreditMemoByItemReport.aspx.cs" Inherits="ABCAPOS.Report.CreditMemo.CreditMemoByItemReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            ...
            <uc2:GenericFilterField ID="gffCustomer" runat="server" FieldName="CustomerName" FieldText="Customer"
            ...
            <uc2:GenericFilterField ID="gffSalesRef" runat="server" FieldName="SalesReference" FieldText="Sales Ref"
                DataType="String" Operator="Like" />
            <uc2:GenericFilterField ID="gffProduct" runat="server" FieldName="ProductCode" FieldText="Product"
                DataType="String" Operator="Like" />
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\CreditMemo\UserControls\CreditMemoByItem.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

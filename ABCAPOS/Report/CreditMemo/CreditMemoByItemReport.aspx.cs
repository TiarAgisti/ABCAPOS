...
{
    public partial class CreditMemoByItemReport : System.Web.UI.Page
    {
        ...
        private void SetDataSource()
        {
            ...
            var customer = "";
            if (gffCustomer.Selected == true)
                customer = gffCustomer.TextBoxString.Text;
            ...
            var product = "";
            if (gffProduct.Selected == true)
                product = gffProduct.TextBoxString.Text;

            var list = new ABCAPOSReportDAC().RetrieveCreditMemoByItem(startDate, endDate, customer, salesRef, product, warehouseName);
            ...
            ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("CreditMemoByItemDT", dt as DataTable));

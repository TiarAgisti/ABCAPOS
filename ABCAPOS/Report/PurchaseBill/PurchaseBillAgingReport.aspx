<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="PurchaseBillAgingReport.aspx.cs" Inherits="ABCAPOS.Report.PurchaseBill.PurchaseBillAgingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <filterfields>
            ...
            <uc2:GenericFilterField ID="gffAgingType" runat="server" FieldName="agingType" FieldText="JATUH TEMPO"
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\PurchaseBill\UserControls\PurchaseBillAging.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

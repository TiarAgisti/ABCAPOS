<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="FulfillmentByItemDetail.aspx.cs" Inherits="ABCAPOS.Report.DeliveryOrder.FulfillmentByItemDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            <uc2:GenericFilterField ID="gffDate" runat="server" FieldName="DeliveryOrderDate" FieldText="Tanggal SJ"
                Type="DateRange" Selected="true" />
            <uc2:GenericFilterField ID="gffProductName" runat="server" FieldName="ProductName" FieldText="Item"
            ...
            <uc2:GenericFilterField ID="gffStatus" runat="server" FieldName="DeliveryOrderStatus" FieldText="Status"
                Type="List" DataType="Integer" />
        </FilterFields>
    </uc1:GenericFilter>
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\DeliveryOrder\UserControls\FullfillmentByItemDetail.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="FulfillmentByItemSummary.aspx.cs" Inherits="ABCAPOS.Report.DeliveryOrder.FulfillmentByItemSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            <uc2:GenericFilterField ID="gffDate" runat="server" FieldName="Date" FieldText="Tanggal SJ"
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\DeliveryOrder\UserControls\FulfillmentByItemSummary.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="DeliveryOrderReport.aspx.cs" Inherits="ABCAPOS.Report.DeliveryOrder.DeliveryOrderReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            ...
            <uc2:GenericFilterField ID="gffCode" runat="server" FieldName="Code" FieldText="SJ NO"
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\DeliveryOrder\UserControls\DeliveryOrder.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

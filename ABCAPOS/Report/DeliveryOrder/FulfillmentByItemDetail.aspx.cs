...
{
    public partial class FulfillmentByItemDetail : System.Web.UI.Page
    {
        ...
        {
            var list = new ABCAPOSReportDAC().RetreiveDeliveryOrderByItemDetail(GenericFilter1.SelectFilters);

<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="PaymentReport.aspx.cs" Inherits="ABCAPOS.Report.Payment.PaymentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            <uc2:GenericFilterField ID="gffDate" runat="server" FieldName="Date" FieldText="Tanggal Transaksi"
                ...
                <uc2:GenericFilterField ID="gffCode" runat="server" FieldName="Code" FieldText="Kode Pembayaran" DataType="String" Operator="Like" />
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Payment\UserControls\Payment.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

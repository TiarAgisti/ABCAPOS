...
namespace ABCAPOS.Report.Payment
{
    public partial class PaymentReport : System.Web.UI.Page
    {
        ...
        {
            var list = new ABCAPOSReportDAC().RetrievePaymentReport(GenericFilter1.SelectFilters);
        ...
        private string GenerateFromXML()
        {
            ...
            rpt.DataSourceItemType = typeof(v_Rpt_Payment);

            ReportHelper.ReadFromXML(rpt, SystemConstants.ReportXMLFolder + "Payment/ReportXML/Payment.xml");

<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="PaymentBillReport.aspx.cs" Inherits="ABCAPOS.Report.Payment.PaymentBillReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            ...
            <uc2:GenericFilterField ID="gffBillCode" runat="server" FieldName="BillCode" FieldText="BILL NUMBER" DataType="String" Operator="Like" />
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Payment\UserControls\PaymentBill.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

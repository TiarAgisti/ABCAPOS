<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="ProfitAndLoss.aspx.cs" Inherits="ABCAPOS.Report.Accounting.ProfitAndLoss" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Accounting\UserControls\ProfitAndLoss.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

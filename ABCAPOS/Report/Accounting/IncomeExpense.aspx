<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="IncomeExpense.aspx.cs" Inherits="ABCAPOS.Report.Accounting.IncomeExpense" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            <%--<uc2:GenericFilterField ID="gffYear" runat="server" FieldName="Date" FieldText="Tahun" Type="List" Selected="true" />--%>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Accounting\UserControls\IncomeExpense.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

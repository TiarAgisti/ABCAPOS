<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true"
    CodeBehind="TrialBalance.aspx.cs" Inherits="ABCAPOS.Report.Accounting.TrialBalance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Accounting\UserControls\TrialBalance.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true" CodeBehind="AccountTransaction.aspx.cs" Inherits="ABCAPOS.Report.Accounting.AccountTransaction" %>
...
<uc1:GenericFilter ID="GenericFilter1" runat="server" OnFilter="GenericFilter1_Filter">
        <FilterFields>
            ...
            <uc2:GenericFilterField ID="gffAccount" runat="server" FieldName="AccountID" FieldText="ACCOUNT"
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\Accounting\UserControls\AccountTransaction.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>

<%@ Page Language="C#" MasterPageFile="~/Report/Site.Master" AutoEventWireup="true" CodeBehind="GoodsSoldByProduct.aspx.cs" Inherits="ABCAPOS.Report.Stock.GoodsSoldByProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
        ...
        <LocalReport ReportPath="Report\GoodsSoldByProduct\UserControls\GoodsSoldByProduct.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>